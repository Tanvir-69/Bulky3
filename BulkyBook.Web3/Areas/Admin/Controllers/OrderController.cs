...
namespace BulkyBook.Web3.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult ShipOrder()
        {
            ...
            {
                orderHeader.PaymentDuoDate = DateOnly.FromDateTime(DateTime.Now.AddDays(30));
            }
        ...
        public IActionResult CancelOrder()
        {
            ...
            if(orderHeader.PaymentStatus == SD.PaymentStatusApproved)
            {
                var options = new RefundCreateOptions
                {
                    ...
                    PaymentIntent = orderHeader.PatmentIntentId
                };
        ...
        public IActionResult Details_PAY_NOW()
        {
            OrderViewModel = new()
            {
                OrderHeader = _unitOfWork.OrderHeader.Get(u => u.Id == OrderViewModel.OrderHeader.Id, includeProperties: "ApplicationUser"),
                OrderDetails = _unitOfWork.OrderDetail.GetAll(u => u.OrderHeaderId == OrderViewModel.OrderHeader.Id, includeProperties: "Product")
            };
